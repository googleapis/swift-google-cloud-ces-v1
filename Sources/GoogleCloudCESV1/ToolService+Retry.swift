...
extension Clients {
  final class ToolServiceRetry: ToolServiceStub {
    ...
    public init(_ inner: any ToolServiceStub, options: GoogleGax.ClientOptions) {
      self.inner = inner
    ...
    public func executeTool(
      ...
      try await self._intercept(
        ...
        idempotent: false,
        action: {
          (r: ExecuteToolRequest, o: GoogleGax.RequestOptions) async throws
    ...
    public func retrieveToolSchema(
      ...
      try await self._intercept(
        ...
        idempotent: false,
        action: {
          (r: RetrieveToolSchemaRequest, o: GoogleGax.RequestOptions) async throws
    ...
    public func retrieveTools(
      ...
      try await self._intercept(
        ...
        idempotent: false,
        action: {
          (r: RetrieveToolsRequest, o: GoogleGax.RequestOptions) async throws
